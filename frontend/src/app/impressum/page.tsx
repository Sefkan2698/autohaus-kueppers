        ...
        <div className="prose prose-sm md:prose-base max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              <strong>Handelsregister:</strong> 1677
              <br />
              <strong>Registergericht:</strong> Amtsgericht Kleve
            </p>
            <p className="text-gray-700 leading-relaxed mt-4">
              <strong>Vertreten durch die Geschäftsführer:</strong> Hans-Theo Küppers
            </p>
          </section>

          {/* Kontakt */}
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Kontakt</h2>
            <p className="text-gray-700 leading-relaxed">
              <strong>Telefon:</strong> 0 28 23 - 31 43
              <br />
              <strong>Telefax:</strong> 0 28 23 - 12 63
              <br />
              <strong>E-Mail:</strong>{' '}
              <a href="mailto:info@auto-kueppers.de" className="text-primary hover:underline">
          ...
          {/* Umsatzsteuer */}
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Umsatzsteuer</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Urheberrecht */}
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Urheberrecht</h2>
            <p className="text-gray-700 leading-relaxed">
