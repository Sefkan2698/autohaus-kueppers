...
router.post('/image', authMiddleware, uploadLimiter, upload.single('image'), async (req, res) => {
    try {
        if (!req.file) {
...
router.post('/images', authMiddleware, uploadLimiter, upload.array('images', 10), async (req, res) => {
    try {
